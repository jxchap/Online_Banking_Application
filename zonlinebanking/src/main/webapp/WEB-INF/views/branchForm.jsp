			...
			<table border="1">
				...
				<c:forEach items="${branches }" var="branch">
					<tr>
						...
						<sec:authorize access="hasAuthority('Admin')">
							<td><a href="${pageContext.request.contextPath}/deleteBranch?branchId=${branch.branchId }">Delete</a></td>
							<td><a href="${pageContext.request.contextPath}/updateBranch?branchId=${branch.branchId }">Update</a></td>
						</sec:authorize>
					</tr>
				</c:forEach>
